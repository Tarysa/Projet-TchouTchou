...
/**
 * Class <code>RailCourbeGH</code>La classe RailCoubrGH permet de manipuler des Rails courbés du haut vers la gauche
 * @author  Limousin Lucas, Lafon Gabin, Sendra Thomas
 * @version 1.0 06/12/2021
 */

public class RailCourbeGH extends Case{

	
	/**
	 * Constructeur de la classe RailCourbeGH
	 * @param p : Point qui correspond à l'endroit où se trouvera cet rail
	 */
	public RailCourbeGH(Point p) {
		super(p, 1);
	}
	
	/**
	 * Méthode centre_rotation permettant d'obtenir le centre de notre cercle
     * @return renvoie le point du centre de rotation du rail (ici haut gauche du rail)
	 */
	@Override
	 ...
	 * @return : renvoie 1 si l'objet t traverse la rail dans le sens haut -> gauche (anti-horaire), 2 si l'objet t traverse le rail dans le sens gauche -> haut (horaire), 0 s'il ne peut pas traverser
	 */
	@Override
